...
<html lang="en">
  <head>
    ...
    <title>HBK School | Canteen</title>
                  ...
                  <div class="row">
                    ...
                    <div class="mu-latest-course-single">
                      <figure class="mu-latest-course-img">
                        <a ><img src="assets/img/ice-cream.jpg" alt="img" height="270" width="200"></a>
                      ...
                      <div class="mu-latest-course-single-content">
                        <h4><a >I scream You Scream we all Scream!!</a></h4>
                        <p></p>
                        <div class="mu-latest-course-single-contbottom">
			<form style="height: 0px;width: 0px;" action="canteenbuy2.php">
                          	<input type="hidden" name="pid" value="1001">
                          	<input type="hidden" name="cost" value="100">
				<input type="hidden" name="pname" value="icecream">
				<input type="hidden" name="item_type" value="healthy">
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="mu-latest-course-single">
                      <figure class="mu-latest-course-img">
                        <a ><img src="assets/img/salad.jpg" alt="img"></a>
                        <figcaption class="mu-latest-course-imgcaption">
                          <a >Salad</a>
                          <span>Healthy</span>
                        </figcaption>
                      ...
                      <div class="mu-latest-course-single-content">
                        <h4><a >GO GREEN and CRAZY for Salads!!</a></h4>
                        <p></p>
                        <div class="mu-latest-course-single-contbottom">
			<form style="height: 0px;width: 0px;" action="canteenbuy2.php">
                          	<input type="hidden" name="pid" value="1003">
                          	<input type="hidden" name="cost" value="50">
				<input type="hidden" name="pname" value="salad">
				<input type="hidden" name="item_type" value="healthy">
                          	<input type="submit" name="buy" value="Buy" style="height: 25px; width: 40px; background-color: inherit; border: none; cursor: pointer; color: blue;">
                          </form>
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="mu-latest-course-single">
                      <figure class="mu-latest-course-img">
                        <a ><img src="assets/img/sandwich.jpg" height="270" width="200" alt="img"></a>
                        <figcaption class="mu-latest-course-imgcaption">
                          <a >Sandwich</a>
                          <span>Unhealthy</span>
                        </figcaption>
                      ...
                      <div class="mu-latest-course-single-content">
                        <h4><a >Nothing can satisfy your hunger like a big fat Sandwich!!</a></h4>
                        <p></p>
                        <div class="mu-latest-course-single-contbottom">
		<form style="height: 0px;width: 0px;" action="canteenbuy2.php">
                          	<input type="hidden" name="pid" value="1002">
                          	<input type="hidden" name="cost" value="30">
				<input type="hidden" name="pname" value="sandwich">
				<input type="hidden" name="item_type" value="unhealthy">
                          	<input type="submit" name="buy" value="Buy" style="height: 25px; width: 40px; background-color: inherit; border: none; cursor: pointer; color: blue;">
                          </form>
                          <a class="mu-course-details" >Buy</a>
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="mu-latest-course-single">
                      <figure class="mu-latest-course-img">
                        <a ><img src="assets/img/maggi.jpg" height="270" width="200" alt="img"></a>
                        <figcaption class="mu-latest-course-imgcaption">
                          <a >Maggi</a>
                          <span>Unhealthy</span>
                        </figcaption>
                      ...
                      <div class="mu-latest-course-single-content">
                        <h4><a >Maggie-Sirf naam hi Kaafi hai!! No need any reason for cravings for maggie!!</a></h4>
                        
                        <div class="mu-latest-course-single-contbottom">
                         <form style="height: 0px;width: 0px;" action="canteenbuy2.php">
                          	<input type="hidden" name="pid" value="1005">
                          	<input type="hidden" name="cost" value="20">
				<input type="hidden" name="pname" value="maggie">
				<input type="hidden" name="item_type" value="unhealthy">
                          	<input type="submit" name="buy" value="Buy" style="height: 25px; width: 40px; background-color: inherit; border: none; cursor: pointer; color: blue;">
                          </form>
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="mu-latest-course-single">
                      <figure class="mu-latest-course-img">
                        <a ><img src="assets/img/samosa.jpg" alt="img"></a>
                        <figcaption class="mu-latest-course-imgcaption">
                          <a >Samosa</a>
                          <span>Unhealthy</span>
                        </figcaption>
                      ...
                      <div class="mu-latest-course-single-content">
                        <h4><a >Samossa sab ke favorite!!!.<br>&nbsp</a></h4>
                        <div class="mu-latest-course-single-contbottom">
<form style="height: 0px;width: 0px;" action="canteenbuy2.php">
                          	<input type="hidden" name="pid" value="1004">
                          	<input type="hidden" name="cost" value="25">
				<input type="hidden" name="pname" value="samosa">
				<input type="hidden" name="item_type" value="unhealthy">
                          	<input type="submit" name="buy" value="Buy" style="height: 25px; width: 40px; background-color: inherit; border: none; cursor: pointer; color: blue;">
                          </form>
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="mu-latest-course-single">
                      <figure class="mu-latest-course-img">
                        <a ><img src="assets/img/juice.jpg" height="304" width="200" alt="img"></a>
                        <figcaption class="mu-latest-course-imgcaption">
                          <a >Juice</a>
                      ...
                      <div class="mu-latest-course-single-content">
                        <h4><a >Tasty and healthy! 100% Natural juice without sweetening!</a></h4>
                        
                        <div class="mu-latest-course-single-contbottom">
             <form style="height: 0px;width: 0px;" action="canteenbuy2.php">
                          	<input type="hidden" name="pid" value="1006">
                          	<input type="hidden" name="cost" value="230">
				<input type="hidden" name="pname" value="juicy">
				<input type="hidden" name="item_type" value="healthy">
                          	<input type="submit" name="buy" value="Buy" style="height: 25px; width: 40px; background-color: inherit; border: none; cursor: pointer; color: blue;">
                          </form>
                          <span class="mu-course-price" >₹30</span>
