      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="active"><a href="updateLimit.php">Update Limit</a></li>
   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12">
          ...
          <div class="mu-contact-content">           
            <div class="row">
              <div class="col-md-left">
				...
				<center>
                  <form class="contactform" action="UpdatingLimit.php">
		...
		<p class="comment-form-email">
                      <label for="canteenlimit">Update Canteen limit<span class="required">*</span></label>
